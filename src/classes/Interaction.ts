...
export class ChatInputCommandInteraction {
  constructor (
    options: ChatInputCommandInteractionType
...
export class UserContextMenuCommandInteraction {
  constructor (
    options: UserContextMenuCommandInteractionType
  ) { Object.assign(this, options) }
}
...
export class MessageContextMenuCommandInteraction {
  constructor (
    options: MessageContextMenuCommandInteractionType
  ) { Object.assign(this, options) }
}
...
export class StringSelectMenuInteraction {
  constructor (
    options: StringSelectMenuInteractionType
  ) { Object.assign(this, options) }
}
...
export class UserSelectMenuInteraction {
  constructor (
    options: UserSelectMenuInteractionType
  ) { Object.assign(this, options) }
}
...
export class RoleSelectMenuInteraction {
  constructor (
    options: RoleSelectMenuInteractionType
  ) { Object.assign(this, options) }
}
...
export class MentionableSelectMenuInteraction {
  constructor (
    options: MentionableSelectMenuInteractionType
  ) { Object.assign(this, options) }
}
...
export class ChannelSelectMenuInteraction {
  constructor (
    options: ChannelSelectMenuInteractionType
  ) { Object.assign(this, options) }
}
...
export class ModalSubmitInteraction {
  constructor (
    options: ModalSubmitInteractionType
  ) { Object.assign(this, options) }
}
